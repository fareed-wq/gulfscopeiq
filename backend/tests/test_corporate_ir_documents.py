...
def test_search_corporate_ir_documents_valid(mock_httpx_client):
    async def run_test():
        ...
        """
        mock_httpx_client.stream.return_value = MockStreamContextManager([MockStreamResponse(200, html)])
...
def test_search_corporate_ir_documents_redirect(mock_httpx_client):
    async def run_test():
        ...
        mock_httpx_client.stream.return_value = MockStreamContextManager([redirect, final])
...
def test_search_corporate_ir_documents_size_limit(mock_httpx_client):
    async def run_test():
        ...
        mock_httpx_client.stream.return_value = MockStreamContextManager([MockStreamResponse(200, content)])
